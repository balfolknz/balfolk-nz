export const aboutContent: newsroomAboutContent = {
  ...
  <p>
    <strong>Imagine Balfolk as a vibrant fusion of centuries-old European dance traditions and modern sensibilities. </strong>
      Balfolk is a dynamic and inclusive genre of dance and music that draws from diverse European traditions. <br/>
      What sets it apart is its fusion of traditional elements with modern innovations and a willingness to adapt and evolve. <br/><br/>

      Live music plays a central role in Balfolk events. <br/>
      It features traditional instruments such as fiddles, hurdy-gurdies, bagpipes and accordions often blended in unique combinations with more modern instruments. <br/>
      This fusion of tradition and contemporary sounds creates a musical landscape that appeals to a wide range of tastes and sensibilities.<br/><br/>

      One of the defining features of Balfolk is its emphasis on community and social interaction. <br/>
      It brings together individuals of all ages and skill levels, fostering an inclusive environment where newcomers are warmly welcomed, and experienced dancers happily share their knowledge.<br/>
      This dance form encourages creativity and embraces change, making it an ever-evolving experience with continued relevance and appeal.<br/>
  ...
  allTeams: [
    {
      ...
      lastName: "Parmenter",
      job: "Director",
      imagePath: "/images/profiles/michael parmenter/Michael Parmenter 2.jpg",
      description: `
      <p>
...
export const mediaEnquiriesInfo: mediaEnquiriesInfo = {
  contactEmails: [
    "balfolkauckland@gmail.com",
    "balfolkdunedin@gmail.com",
    "wellingtonbalfolk@gmail.com",
    "balfolkgoldenbay@gmail.com",
    "balfolkchristchurch@gmail.com"
  ],
  imagePath:
