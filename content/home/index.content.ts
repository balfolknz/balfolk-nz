export const heroImagePaths: lowHighResImagePaths[] = [
  ...
  {
    lowResImagePath: "/images/home/main8.jpeg",
    highResImagePath: "/images/home/main8.jpeg",
  }
];
  ...
  allTeams: [
    {
      ...
      description: `
      <p>
        Michael Parmenter <strong>(Balfolk Auckland)</strong> has a long background in contemporary dance, having choreographed over 50 significant works for his own and other major companies. <br/>
    ...
    },
    {
      ...
      description: `
        <p>
          Kate Grace <strong>(Balfolk Dunedin)</strong> hails originally from France where her early encounters with dance included African dance and Contact Improvisation. <br/>
